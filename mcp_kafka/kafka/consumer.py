...
class KafkaConsumer:
    ...
    def list_consumer_groups(self, broker_ids=None):
        ...
        return self._core.kafka_admin_client.list_consumer_groups(broker_ids=broker_ids)
    ...
    def describe_consumer_group(self, group_id: str):
        ...
        return self._core.kafka_admin_client.describe_consumer_group([group_id])

    def delete_consumer_groups(self, group_id: str):
